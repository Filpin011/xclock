import 'package:clock4/alarm_helper.dart';
import 'package:clock4/costant/theme-data.dart';
import 'package:clock4/main.dart';
...
class _AlarmPageState extends State<AlarmPage> {
  ...
  void scheduleAlarm(
    ...
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
      ...
      icon: 'ic_stat_name',
      sound: RawResourceAndroidNotificationSound('sveglia'),
  ...
  void onSaveAlarm() {
    ...
    var alarminfo = AlarmInfo(
      ...
      gradientColorIndex: 0 + _random.nextInt(5 - 0),
      title: 'Alarm',
    );
